// ***************************************************
// APPLICATION PAGE DECLARATION: /admlogger.default.js
...
var $PageController = {
    ...
    init: function(action, default_action) {
        if (this.is_trace)
            alert('admlogger.$PageController.init: '+action+':'+default_action);
    },

    _init_state: function() {
        if (this.IsLog)
            console.log('admlogger.$PageController._init_state:');
    },
    ...
    updateView: function(action, callbacks, response, props, total) {
        if (this.IsLog)
            console.log('admlogger.$PageController.updateView', action, response, props, total);
        ...
        if (this.IsDebug)
            alert('admlogger.$PageController.updateView, action:'+action+', mode:'+mode);
