// ***************************************************
// MAINTENANCE DIALOGS: /maintenancetenence.dialogs.js
// ---------------------------------------------------
// Version: 1.0
// Date: 22-06-2019
...
var $MaintenancetenenceSubmitDialog = {
    base         : $BaseDialog,
        ...
        switch (this.mode) {
            ...
            case 'logsearch':
                ...
                $("#logsearch-context").val()+
                    ...
                    '::'+($("#item-logsearch-maintenancetenence").prop('checked') ? 1 : 0).toString()+
...
jQuery(function($) 
{
    ...
    $("#logsearch-confirm-container").dialog({
        ...
        position:0,
        buttons: [
            {text: keywords['Run'],    click: function() { $MaintenancetenenceSubmitDialog.confirmed(); }},
            {text: keywords['Reject'], click: function() { $MaintenancetenenceSubmitDialog.cancel(); }}
        ],
        modal: false,
        draggable: true,
        resizable: false,
